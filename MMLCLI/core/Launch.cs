        ...
        public async void LaunchGame(string modpackId)
        {
            try
            {
                ...
                if (session != null )
                {
                    ...
                    Console.WriteLine($"{modpackId} game-launched {process.Id.ToString()}");
                    ModpackManager.modpackPids[modpackId] = process.Id;
                    ...
                    process.WaitForExit();
                    Console.WriteLine($"{modpackId} game-closed");
                    
                }
                else
                {
                    Console.WriteLine($"{modpackId} no-account");
                }
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine($"{modpackId} error-launching");
