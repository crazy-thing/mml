    ...
    {showStopGame && (
      ...
      <div className='main-panel-side'>
        ...
        <div className='main-panel-side-banner' style={{background: modpack && modpack.banner}}>
          <img src={`https://minecraftmigos.tech/uploads/thumbnails/${modpack && modpack.thumbnail}`} draggable={false} className='main-panel-side-banner-thumbnail' />
      ...
      <div className='main-panel-right' >
        <img className='main-panel-right-background' src={`https://minecraftmigos.tech/uploads/backgrounds/${modpack && modpack.background}`} draggable={false} />
