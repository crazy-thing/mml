    ...
    return (
        <div className='settings' style={{right: pos}}>
            ...
            <div className='settings-header'>
                ...
                <img className='settings-header-back' src={close} onClick={() => changeSettingPos("-21")} />
            ...
            <div className='settings-mml'>
                ...
                <img className='settings-mml-icon' src={mml} style={{cursor: "pointer"}} onClick={() => openWebsite("https://minecraftmigos.netlify.app/")}/>
                <div className='settings-mml-info-icons'>
                    ...
                    <p className='settings-mml-info-text'> Minecraft Migos Launcher v1.2.0 </p>
            </div>
         </div>
    );
};
